...
class AuthController extends Zend_Controller_Action
{
    ...
    public function loginAction(){
        try{
            ...
            PAP_Helper_Logger::writeLog(Zend_Log::ERR, 'AuthController->loginAction()',$ex, $_SERVER['REQUEST_URI']);
        }
    }
    ...
    public function logoutAction(){
        try{
            ...
            PAP_Helper_Logger::writeLog(Zend_Log::ERR, 'AuthController->logoutAction()',$ex, $_SERVER['REQUEST_URI']);
        }
    }
    ...
    public function homeAction(){
        try{
            ...
            PAP_Helper_Logger::writeLog(Zend_Log::ERR, 'AuthController->homeAction()',$ex, $_SERVER['REQUEST_URI']);
        }
    }
    ...
    public function activateAction(){
        try{
            ...
            PAP_Helper_Logger::writeLog(Zend_Log::ERR, 'AuthController->activateAction()',$ex, $_SERVER['REQUEST_URI']);
        }    
    }
    ...
    public function resendemailAction(){
        try{
            ...
            PAP_Helper_Logger::writeLog(Zend_Log::ERR, 'AuthController->resendemailAction()',$ex, $_SERVER['REQUEST_URI']);
        }
    }
    ...
    private function sendValidationEmail($email){
        try {
            ...
            PAP_Helper_Logger::writeLog(Zend_Log::ERR, 'AuthController->sendValidationEmail()',$ex, $_SERVER['REQUEST_URI']);
        }
    }
