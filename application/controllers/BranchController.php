...
class BranchController extends Zend_Controller_Action
{
    ...
    public function indexAction()
    {
        try{
            ...
            PAP_Helper_Logger::writeLog(Zend_Log::ERR, 'BranchController->indexAction()',$ex, $_SERVER['REQUEST_URI']);
        }    
    ...
    public function newAction()
    {
        try{
            ...
            PAP_Helper_Logger::writeLog(Zend_Log::ERR, 'BranchController->newAction()',$ex, $_SERVER['REQUEST_URI']);
        }    
    }
    ...
    public function categoriesAction()
    {
        try{
            ...
            PAP_Helper_Logger::writeLog(Zend_Log::ERR, 'BranchController->categoriesAction()',$ex, $_SERVER['REQUEST_URI']);
        }    
    }
